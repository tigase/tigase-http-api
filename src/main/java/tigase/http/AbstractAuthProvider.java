...
public abstract class AbstractAuthProvider implements AuthProvider {
	...
	public abstract Duration getAuthenticationTokenValidityDuration();

	protected abstract SecretKeySpec getSecretKey();
		...
		if (payload != null) {
			try {
				...
				setAuthenticationCookie(response, new JWTPayload(payload.subject(), payload.issuer(),
				                                                 LocalDateTime.now().plus(getAuthenticationTokenValidityDuration())),
