...
After navigating to the Admin WebUI you will see basic information about navigation. The panel itself consists of two main parts:
* left navigation menu, which groups all configuration items into categories;
* central, main configuration page displaying configuration options of the selected items.

image:images/adminUI-main.jpg[]
