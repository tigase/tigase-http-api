...
Property accepts list of string, which in case of properties format is list of comma separated domain names and in DSL it is written as list of strings (see <<Complex example>>).
